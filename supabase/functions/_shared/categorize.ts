...
function systemPrompt(locale: Locale): string {
  ...
  return [
    ...
    "  terse input. Hints: water, juice, soda, coffee, tea, snacks, drinks, restaurant or cafe ->",
    "  food; supermarket / household staples -> groceries; taxi, uber, bus, fuel, petrol -> transport;",
